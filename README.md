...
**[Hello-rails-back-end]** Hello-rails-back-end app serves as api for react front-end app.
...
- `git clone ggit@github.com:BranBayou/hello-rails-back-end.git`
...
Feel free to check the [issues page](hhttps://github.com/BranBayou/hello-rails-back-end/issues).
